...
export function BudgetGauge({ budget, maxBudget = 200_000_000 }: BudgetGaugeProps) {
  ...
  return (
    <div className="space-y-1">
      <div className="w-full h-[42px] bg-deep-space-100 border border-blue-500 relative flex items-center justify-center">
        <div 
        ...
        {[16.67, 33.33, 50, 66.67, 83.33].map((pos, i) => (
          <div
            key={i}
            className="absolute top-0 h-full w-px bg-blue-400 z-[5]"
            style={{ left: `${pos}%` }}
          />
        ))}
