...
export function ControlPanel() {
  ...
  return (
    <>
      <div className="bg-deep-space-200 border-4 border-cyber-cyan-800 px-6 pt-1 pb-6 w-full h-[1100px] flex flex-col shadow-depth-lg relative overflow-hidden">
      ...
      <div className="pt-4 border-t border-deep-space-50" style={{ marginTop: launchType === 'drv' ? '5px' : '0' }}>
        ...
        <button
          ...
          disabled={!canAfford}
          className={`w-[calc(100%-10px)] mx-auto block py-[11px] px-6 border-2 font-bold uppercase tracking-wide transition-all mt-[20px] text-lg ${
            canAfford
